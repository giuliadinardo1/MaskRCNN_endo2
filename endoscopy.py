...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + beagle
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("endoscopy", 1, "gallbladder")
        self.add_class("endoscopy", 2, "grasper")
        self.add_class("endoscopy", 3, "Rsulcus")
        ...
        for a in annotations:
            ...
            for n in objects:
                try:
                    if n['endoscopy'] == 'gallbladder':
                        num_ids.append(1)
                    elif n['endscopy'] == 'grasper':
                        num_ids.append(2)
                    elif n['endoscopy'] == 'Rsulcus':
                        num_ids.append(3)
                except:
                    pass
            ...
            self.add_image(
                "endoscopy",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "endoscopy":
